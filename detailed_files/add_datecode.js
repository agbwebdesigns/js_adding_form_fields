...
function checkallListenerAdd(y)  {  //this function adds listeners to all checkall checkboxes that were created when a new datecode is added
    ...
    checkAllShowHideArray[y].addEventListener('click',(t) =>  {
        ...
        function cbClickRunner(y,w,cbClick)  {  //when clicked, this function runs through the showHideArray and changes the checked property of all show/hide checkboxes for the given datecode to true or false, then adds or removes the no-print class
